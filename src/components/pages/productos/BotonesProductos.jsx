  ...
  <section className="mt-1 imagen-fondo">
    <div className="container-fluid pt-2 pb-2">
      <div className="row d-flex align-content-center ">
        <div className="col-4 col-sm-4 col-md-4 col-lg-4 btn-ref"><button href="#" onClick={()=> updateTortas() && setTartaletasList([])} className="btn botones">Tortas</button></div>
        <div className="col-4 col-sm-4 col-md-4 col-lg-4 btn-ref"><button href="#" onClick={()=> updateTartaletas() && setTortasList([])} className="btn botones">Tartaletas</button></div>
        <div className="col-4 col-sm-4 col-md-4 col-lg-4 btn-ref"><button href="#" className="btn botones">Extras</button></div>
      </div>
    </div>
  </section>
  <section>
